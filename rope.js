class Rope
  {
    //nlink é número de linha
    //pointA são pontos de conexão 
    constructor(nlink, pointA)
    {
      this.nlink = nlink
  const group = Body.nextGroup(true);
  //Composites.stack é para criar varios corpos retangulares 
  ...
  World.add(engine.world, this.body);
    ...
    //Constraint.create conecta todas as cordas
